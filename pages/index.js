      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            De Toekomst van Crypto Beleggen
          </h1>
          <p style={{
            fontSize: '1.3rem',
            marginBottom: '40px',
            ...
            Beheer je cryptocurrency portfolio met geavanceerde tools voor staking, 
            arbitrage en airdrop jacht. Verdien meer met minder risico.
          </p>
          <div style={{
            display: 'flex',
            gap: '20px',
